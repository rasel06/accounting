    ...
    <div class="w-full mx-auto px-4 bg-slate-300 rounded-lg ">
        <div class="flex flex-col items-stretch">
            ...
            <x-helpers.parts.data-table.control :showStatus="false">
                ...
                <select wire:model.change="creditAccountFilter" class="border-gray-100 rounded ml-2 py-1 pr-8 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-300">
